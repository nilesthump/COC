...
GoldStorage* GoldStorage::create(const std::string& textureName, int hp, int lv, float x0, float y0)
{
...
bool GoldStorage::init(const std::string& textureName, int hp, int lv, float x0, float y0)
{
    if (!Node::init())
    {
        return false;
