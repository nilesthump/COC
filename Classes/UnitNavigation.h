...
public:
    ...
    virtual BattleUnit* FindTarget(BattleUnit* self, const std::vector<BattleUnit*>& allTargets) = 0;
    virtual void CalculateMove(BattleUnit* self, BattleUnit* target, float deltaTime) = 0;
