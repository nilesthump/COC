...
//身份标识
enum class UnitType { NONE, BARBARIAN, ARCHER, GIANT, GOBLIN, BOMBER, BALLOON };
enum class BuildingType { NONE, TOWN_HALL, CANNON, ARCHER_TOWER,MORTAR, GOLD_MINE, GOLD_STORAGE, ELIXIR, ELIXIR_STORAGE, WALL,BUILDERSHUT };
