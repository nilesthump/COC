...
GoldMine* GoldMine::create(const std::string& textureName, int original_hp,int lv, float x0, float y0)
{
...
bool GoldMine::init(const std::string& textureName, int original_hp,int lv, float x0, float y0)
{
    if (!Node::init())
    {
        return false;
